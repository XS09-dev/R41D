...
class Achievements {
	public static var achievementShits:Array<Dynamic> = [//Name, Description, Achievement save tag, Unlocks after, Hidden achievement
		...
		["You'll pay for that",		"Beat Week 1 on Hard with no Misses.",				'week1_nomiss',			'week1', 		false],
		["Spooky Month!",				"Beat Week 2 on Hard with no Misses.",				'week2_nomiss',         'week2', 		false],
		["Go Pico yea yea",			"Beat Week 3 on Hard with no Misses.",				'week3_nomiss',			'week3', 		false],
